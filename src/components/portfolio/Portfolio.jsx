...
const items = [
  {
    ...
    title: "HEY'U",
    img: "/heyu1.png",
    desc: `This innovative mobile app bridges the gap between clients and guards for seamless mission coordination. Key features I developed:

• Custom Native Modules for Dual Camera Recording
...
• Core Features:
  ...
  - Seamless communication through Intercom

The dual camera feature required deep knowledge of native iOS and Android camera APIs, significantly enhancing the app's security monitoring capabilities.`,
